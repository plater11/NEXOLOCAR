...
export type Database = {
  public: {
    Tables: {
      ...
      pedidos: Table<{ id: string; codigo_pedido: string; cliente_id: string; fecha: string; subtotal: number; descuento: number; total: number; estado_operativo: string; estado_entrega: string; estado_cobranza: string; estado_boleta: string; codigo_impresion: string | null; fecha_impresion: string | null; observaciones: string | null; subestado_operativo: string | null; motivo_incidencia: string | null; fecha_reprogramada: string | null; fecha_vencimiento_cobro: string | null; usuario_creacion: string | null; legacy_id: string | null; legacy_row: number | null; legacy_source: string | null; idempotency_key: string | null; version: number; created_at: string; updated_at: string }>;
