...
export type Database = {
  public: {
    Tables: {
      clientes: Table<{ id: string; codigo: string; nombre: string; telefono: string | null; direccion: string | null; correo: string | null; fecha_nacimiento: string | null; observaciones: string | null; estado: string; legacy_id: string | null; created_at: string; updated_at: string }>;
